          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                ...
                <p className="mb-8 max-w-[480px] text-base text-gray-100 dark:text-gray-50-6 flex flex-wrap items-center gap-3">
                  Avec Doc4now, la prise de Rendez-vous est largement facilitée,
                  vous pourrez choisir votre médecin selon la spécialité, les
                  ssymptômes, la proximité, dans votre liste de médecins...
                </p>
                {/* Search Bar Here */}
                ...
                <div className="py-4 pt-8 flex gap-4">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-sm text-gray-300">Spécialistes</span>
                  </div>
                  <div className="flex flex-col items-center justify-center">
